...
{ 
    ...
    {  /// <summary>
        ...
        /// <returns>O resultado da conversão da distancia.</returns>         

        public static double ConversaoDistancias(ConversaoDistancia conversao, double distancia)
        {
